...
const Reviews = () => {
          ...
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Event Success Stories</h2>
          <p className="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Explore the stories of how we made weddings, anniversaries, birthdays, and more truly unforgettable.</p>
          </div>
          <div className="grid gap-8 md:grid-cols-2">
          {testimonials.map((testimonial, index) => (
          <div key={index} className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          <div className="mb-4">
          <img className="w-16 h-16 rounded-full mx-auto" src={testimonial.avatar} alt={`profile picture of ${testimonial.name}`} />
          </div>
