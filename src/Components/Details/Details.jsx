...
const Details = () => {
          ...
          <img className="w-full rounded-xl" src="https://templates.hibotheme.com/wazo/default/assets/img/service/single-service-1.jpg" alt="Event Image" />
          </div>
          <div className='my-3'>
          <h1 className='lg:text-4xl font-semibold'>About This Service</h1>
          </div>
