...
const About = () => {
          ...
          <div data-aos="fade-left" className="col-span-5">
          ...
          <div data-aos="fade-up" className="space-y-2 md:space-y-4">
          ...
          <FaCheckCircle data-aos="fade-right" className="flex-shrink-0 h-6 w-6 text-blue-600 dark:text-blue-500" />
          <span data-aos="fade-left" className="text-sm sm:text-base text-gray-500">
