    ...
    <h2 className="max-w-lg mb-6  text-4xl font-semibold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
      <span className="relative inline-block">
        <svg
          viewBox="0 0 52 24"
          fill="currentColor"
          className="absolute top-0 left-0 z-0 hidden w-32 -mt-8 -ml-20 text-[#1c6e5f] lg:w-32 lg:-ml-28 lg:-mt-10 sm:block"
        >
          <defs>
            <pattern
  ...
  <div className="grid gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3">
    <div className="flex">
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-sm text-gray-800">Event Planner</p>
      </div>
    </div>
    <div className="flex">
      <img
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-sm text-gray-800">Event Designer</p>
      </div>
    </div>
    <div className="flex">
      <img
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-sm text-gray-800">Event Coordinator</p>
      </div>
    </div>
    <div className="flex">
      <img
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-sm text-gray-800">Event Manager</p>
      </div>
    </div>
    <div className="flex">
      <img
